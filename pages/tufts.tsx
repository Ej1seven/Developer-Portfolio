        ...
        <div className="w-full flex flex-col relative">
          ...
          <div className="w-full mt-16">
            <ul className="mb-4">
              ...
              <li>
                <span className="font-bold">Client:</span> Tufts University (via
                Launch Theory)
              </li>
              <li>
                <span className="font-bold">Technologies:</span> Drupal 10,
                Sass, jQuery, Twig, Lando, Pantheon
              </li>
            </ul>
            <p className="text-sm md:text-base">
              As part of a fast-paced development team at Launch Theory, I
              contributed to the build and launch of a Drupal 10 website for
              Tufts University. This was my first professional project with a
              startup, and it gave me hands-on experience working under tight
              deadlines and collaborating in a fast-moving environment. I
              configured the local development environment using Lando to ensure
              seamless integration with Pantheon&#39;s continuous deployment
              pipeline. I supported codebase versioning and deployment workflows
              using Pantheon&#39;s tools, helping maintain smooth team
              operations. On the front end, I helped develop a custom Drupal 10
              theme using Sass, applying modular and reusable variables and
              mixins to create scalable, maintainable styles. I ensured the
              theme followed responsive design principles and was mobile-first
              and cross-browser compatible. Using jQuery, I implemented custom
              ...
              and collaboration in fast-paced team environments.
            </p>
          </div>
        </div>
      </div>
