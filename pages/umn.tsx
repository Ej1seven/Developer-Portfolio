        ...
        <div className="w-full flex flex-col relative">
          ...
          <div className="w-full mt-16">
            <p className="text-sm md:text-base">
              ReportWeaver is a full-stack application that automates the
              retrieval and processing of accessibility reports. The backend,
              constructed using Java Spring Boot, executes Selenium requests to
              extract data from PopeTech, a web accessibility and reporting
              tool. The extracted data is then formatted and stored in a Google
              Sheet using the Google Docs API, and the generated sheet URL is
              provided to the frontend for user access.
              <ul className="mt-4 w-4/5 m-auto">
                <li> ✅ Extracts accessibility reports using Selenium</li>
                <li>✅ Formats data into Google Docs automatically</li>
                <li> ✅ Provides real-time updates via WebSockets</li>
