        ...
        <div className="w-full flex flex-col relative">
          ...
          <div className="w-full mt-16">
            <p className="text-sm md:text-base">
              ...
              technology. The era of Web 3.0 has enabled decentralized data
              interconnection. This could allow people the opportunity to
              reclaim ownership and control over their private data. Kryptoturf
              is a dApp designed to allow users the ability to participate in
              the world of NFTs. I created this application solely for testing
              purposes, with this in mind I decided to run Kryptoturf on the
              Goerli testnet. My objective in developing this application was to
              test my front-end and back-end coding skills by creating a
              comprehensive, complex and user-friendly application. I hope you
              enjoy!
            </p>
